...
<body>
    ...
    <section>
        ...
        <div class="category">
            ...
            <a href="../bitirme_projesi/books/pdf10.pdf" download="Natural history">
                <button class="download-button" onclick="downloadBook('Natural history')">Download</button>
            </a>
        </div>
        </div>
        <div class="category">
            <img src="../bitirme_projesi/images/books/history7.jpeg" alt="Book">
            <h3>The personal history of David Copperfield</h3>
            <p>by Charles Dickens</p>
            <a href="../bitirme_projesi/books/pdf11.pdf" download="The personal history of David Copperfield">
        ...
        <div class="category">
            <img src="../bitirme_projesi/images/books/history8.jpeg" alt="Book">
            <h3>Histories Book III</h3>
            <p>by Thucydides</p>
            <a href="../bitirme_projesi/books/pdf12.pdf" download="Study of history">
        ...
        <div class="category">
            ...
            <p>by Paul S. Boyer</p>
            <a href="../bitirme_projesi/books/pdf8.pdf" download="The Enduring Vision: A History of the American People">
                <button class="download-button" onclick="downloadBook('The Enduring Vision: A History of the American People')">Download</button>
            </a>
        </div>
        <div class="category">
            <img src="../bitirme_projesi/images/books/history9.jpeg" alt="Book">
            <h3>History</h3>
            <p>by Herodotus</p>
            <a href="../bitirme_projesi/books/pdf9.pdf" download="History">
                <button class="download-button" onclick="downloadBook('History')">Download</button>
            </a>
        </div>
        <div class="category">
            <img src="../bitirme_projesi/images/books/history10.jpeg" alt="Book">
            <h3>History of the Decline and Fall of the Roman Empire</h3>
            <p>by Edward Gibbon</p>
            <a href="../bitirme_projesi/books/pdf10.pdf" download="History of the Decline and Fall of the Roman Empire">
                <button class="download-button" onclick="downloadBook('History of the Decline and Fall of the Roman Empire')">Download</button>
            </a>
        </div>
        <div class="category">
            <img src="../bitirme_projesi/images/books/history11.jpeg" alt="Book">
            <h3>Natural history</h3>
            <p>by Pliny the Elder</p>
            <a href="../bitirme_projesi/books/pdf11.pdf" download="Natural history">
                <button class="download-button" onclick="downloadBook('Natural history')">Download</button>
            </a>
        </div>
        <div class="category">
            <img src="../bitirme_projesi/images/books/history12.jpeg" alt="Book">
            <h3>The personal history of David Copperfield</h3>
            <p>by Charles Dickens</p>
            <a href="../bitirme_projesi/books/pdf12.pdf" download="The personal history of David Copperfield">
        ...
        <div class="category">
            ...
            <a href="../bitirme_projesi/books/pdf1.pdf" download="by William Shakespeare">
        ...
        <div class="category">
            ...
            <a href="../bitirme_projesi/books/pdf2.pdf" download="Eventyr og historier">
        ...
        <div class="category">
            ...
            <h3>Roman history</h3>
            <p>by James Joyce</p>
            <a href="../bitirme_projesi/books/pdf3.pdf" download="Roman history">
        ...
        <div class="category">
            ...
            <a href="../bitirme_projesi/books/pdf4.pdf" download="The history of Don Quixotey">
        ...
        <div class="category">
            ...
            <a href="../bitirme_projesi/books/pdf5.pdf" download="The Awakening">
        ...
        <div class="category">
            ...
            <p>by Arnold J. Toynbee ve D.C Somervell</p>
            <a href="../bitirme_projesi/books/pdf6.pdf" download="Study of history">
                <button class="download-button" onclick="downloadBook('Study of history')">Download</button>
            </a>
        </div>
        ...
        <div class="category">
            ...
            <h3>The Enduring Vision: A History of the American People</h3>
            <p>by Paul S. Boyer</p>
            <a href="../bitirme_projesi/books/pdf7.pdf" download="The Enduring Vision: A History of the American People">
                <button class="download-button" onclick="downloadBook('The Enduring Vision: A History of the American People')">Download</button>
            </a>
        </div>
        ...
        <div class="category">
            ...
            <h3>History</h3>
            <p>by Herodotus</p>
            <a href="../bitirme_projesi/books/pdf8.pdf" download="History">
                <button class="download-button" onclick="downloadBook('History')">Download</button>
            </a>
        </div>
        </div>
        <div class="category">
            ...
            <h3>History of the Decline and Fall of the Roman Empire</h3>
            <p>by Edward Gibbon</p>
            <a href="../bitirme_projesi/books/pdf9.pdf" download="History of the Decline and Fall of the Roman Empire">
                <button class="download-button" onclick="downloadBook('History of the Decline and Fall of the Roman Empire')">Download</button>
            </a>
        </div>
        </div>
        ...
        <div class="category">
            ...
            <h3>Study of history</h3>
            <p>by Arnold J. Toynbee ve D.C Somervell</p>
            <a href="../bitirme_projesi/books/pdf7.pdf" download="Study of history">
                <button class="download-button" onclick="downloadBook('Study of history')">Download</button>
            </a>
        </div>
